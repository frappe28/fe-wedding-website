...
<template>
  <VCard title="🕺🏻💃🏻 Dopo la cerimonia, ci vediamo qui:" class="position-relative v-text-wrap-justify">
    <template #subtitle>
      <p class="text-body-1 mb-0 mt-">
        ...
        <br>
        <span class="v-text-wrap-justify">dopo l'abbuffata si continua a ballare!</span>
      </p>
    </template>
